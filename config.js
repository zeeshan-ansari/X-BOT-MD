...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:1450438cad6e14e6b947c39b29da69a8";
const SUDO = process.env.SUDO || '923272952948';
...
const BOT_INFO = process.env.BOT_INFO || "ZEEAHAN;ANSARI;https://i.imgur.com/r3GZeiX.jpeg";
const URL = process.env.URL || "https://www.instagram.com/absolutely_sparky";
const AUDIO_DATA = process.env.AUDIO_DATA || "ZEEAHAN;ANSARI;https://i.imgur.com/fVCRCYG.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "ZEEAHAN;ANSARI";
